...
<section class="flex flex-col items-center justify-center w-100">
    <div id="drawer-contact" class="  p-4   bg-white w-80 dark:bg-gray-800" tabindex="" aria-labelledby="">
        <h5 id="drawer-label"
            class="flex items-center mb-6 text-base font-semibold text-gray-500 uppercase dark:text-gray-400"><svg
        ...
        <button type="button" data-drawer-dismiss="drawer-contact" aria-controls="drawer-contact"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
